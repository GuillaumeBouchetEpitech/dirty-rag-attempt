...
// const _initializeSkLearnDocVectorStore = async (myOllama: MyOllama): Promise<MyVectorStore> => {
...
//   myOllama: MyOllama,
//   skLearnDocVectorStore: MyVectorStore
// ): {
//   allTools: ITool[];
...
//   // const get_sklearn_context_def: ITool = {
//   //   type: "function",
//   //   function: {
//   //     name: "get_sklearn_context",
...
//   // const get_sklearn_context_impl = async (
//   //   options: IToolUse
...
//     const retrievedTexts = await skLearnDocVectorStore.query(question, maxRetrieval);
...
//     [
//       get_sklearn_context_def.function.name,
//       get_sklearn_context_impl
//     ],
//     [
...
//   const skLearnDocVectorStore = await _initializeSkLearnDocVectorStore(myOllama);

//   const { allTools, toolsMap } = _initializeToolCalling(myOllama, skLearnDocVectorStore);
